...
% The \gls{hps} method builds up a set of solution operators that represent the factorization of the system matrix $\textbf{A}$. Building the factorization set involves starting at the leaf-level to compute local solution operators, then successively merging a small subset of subdomains. 
