...
To provide an analytical solution to compare against, we use a problem provided in \cite{cheng2006adaptive} where they solve Helmholtz's equation on an adaptive mesh. The manufactured solution is
\begin{align}
