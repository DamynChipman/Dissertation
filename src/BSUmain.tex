...
% \input{chapters/ch01-intro/elliptic-pdes-and-methods.tex}
...
\input{chapters/ch03-quadtree-adaptive-hps/problem-statement.tex}
...
\input{chapters/ch05-parallel-hps/parallel-results.tex}
\input{chapters/ch05-parallel-hps/conclusion.tex}

\chapter{Software and Code Comparisons}
\label{chap:software-and-code}
\input{chapters/ch06-software-and-code/intro.tex}
\input{chapters/ch06-software-and-code/software.tex}
\input{chapters/ch06-software-and-code/cases.tex}
\input{chapters/ch06-software-and-code/conclusion.tex}

\chapter{Conclusion and Future Work}
\label{chap:conclusion}
\input{chapters/ch07-conclusion/conclusion.tex}
\input{chapters/ch07-conclusion/future-work.tex}
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
% bibliography:
% \cleardoublepage
