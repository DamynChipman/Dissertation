...
%------------------------------------------------------------------------------
\discipline{Computing --- Computational Science and Engineering}
%------------------------------------------------------------------------------
\title{A Fast and Scalable Direct Solver for Elliptic Partial Differential Equations on a Hierarchy of Adaptively Refined 2D Finite Volume Meshes} % use correct capitalization
%------------------------------------------------------------------------------
\advisor{Donna Calhoun}{Ph.D.}
\committeeMemberA{Michal Kopera}{Ph.D.}
\committeeMemberB{Grady Wright}{Ph.D.}
% \extmember{Kirk Ketelsen}{Ph.D.}{Graduate Faculty Representitive}
%------------------------------------------------------------------------------
\dean{Tammi Vacha-Haase}{Dean of the Graduate College}
%------------------------------------------------------------------------------
% insert month and year of your thesis, only:
\date{June 2024}
\oralexamdate{01 Jan 1970}
%------------------------------------------------------------------------------
\maketitle
%------------------------------------------------------------------------------
\makecopyright
...
%------------------------------------------------------------------------------
\setcounter{page}{4}
% \input{preliminaries/dedication.tex}
% \input{preliminaries/acknowledgment.tex}
% \input{preliminaries/autobiographics.tex}
...
\label{chap:intro}
\input{chapters/ch01-intro/intro.tex}
\input{chapters/ch01-intro/literature-review.tex}
\input{chapters/ch01-intro/novelty.tex}
\input{chapters/ch01-intro/overview.tex}

\chapter{Elliptic PDEs and Classic Solution Methods}
\label{chap:elliptic-pdes}
\input{chapters/ch02-elliptic-pdes/elliptic-pde.tex}
\input{chapters/ch02-elliptic-pdes/numerical-methods.tex}
\input{chapters/ch02-elliptic-pdes/solution-methods.tex}

\chapter{The Quadtree-Adaptive HPS Method on a Hierarchy of 2D Finite Volume Meshes}
\label{chap:qahps}
\input{chapters/ch03-quadtree-adaptive-hps/introduction.tex}
\input{chapters/ch03-quadtree-adaptive-hps/quad-donna.tex}
\input{chapters/ch03-quadtree-adaptive-hps/implementation-details.tex}
\input{chapters/ch03-quadtree-adaptive-hps/results.tex}
\input{chapters/ch03-quadtree-adaptive-hps/conclusion.tex}

\chapter{An Adaptive Rebuild Improvement to the Quadtree-Adaptive HPS Method}
\label{chap:adaptive-build}
\input{chapters/ch04-adaptive-rebuild-hps/introduction.tex}
\input{chapters/ch04-adaptive-rebuild-hps/math-theory.tex}
\input{chapters/ch04-adaptive-rebuild-hps/adaptive-rebuild.tex}
\input{chapters/ch04-adaptive-rebuild-hps/numerical-experiments.tex}
\input{chapters/ch04-adaptive-rebuild-hps/conclusion.tex}

\chapter{A Parallel Implementation of the Quadtree-Adaptive HPS Method for Distributed Memory Platforms}
\label{chap:parallel}
\input{chapters/ch05-parallel-hps/introduction.tex}
\input{chapters/ch05-parallel-hps/parallel-algorithm.tex}
\input{chapters/ch05-parallel-hps/implementation-details.tex}
\input{chapters/ch05-parallel-hps/scaling-analysis.tex}
\input{chapters/ch05-parallel-hps/conclusion.tex}
...
\input{chapters/ch07-conclusion/conclusion.tex}
%------------------------------------------------------------------------------
%------------------------------------------------------------------------------
% bibliography:
% \cleardoublepage
